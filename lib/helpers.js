...
function getCLIArguments() {
    return yargs
        ...
        .options({
			...
			'hardware': {
                default: userSettings['hardware'] || false,
                describe: 'Enables hardware acceleration (NVIDIA).',
                type: 'boolean',
                group: 'Advanced:'
            },
			'h264': {
                default: userSettings['h264'] || false,
                describe: 'Uses h264 instead of h265.',
                type: 'boolean',
                group: 'Advanced:'
            },
			'vcodec': {
                default: userSettings['vcodec'] || false,
                describe: 'Use a specific video codec (check ffmpeg for list of supported values).',
                type: 'string',
                group: 'Advanced:'
            },
			'acodec': {
                default: userSettings['acodec'] || false,
                describe: 'Use a specific audio codec (check ffmpeg for list of supported values).',
                type: 'string',
                group: 'Advanced:'
            },
        })
